...
| 0002  | Seleccionar un caramelo | Iniciar el nivel. Hacer click sobre un caramelo                                                                              | Cambie la apariencia del Sprite.                                         | El caramelo se torna de una tonalidad oscura.                                  |
| 0003  | Intrcambiar un caramelo en dirección horizontal y vertical       | Iniciar el nivel. Hacer click sobre un caramelo. Hacer click sobre alguno de los caramelos adyacentes.                                                                                | Que el primer caramelo seleccionado intercambie de lugar con el segundo.                                                          | Los caramelos intercambian de lugar.                                      |
| 0004  | Destruit una combinacion de tres o mas caramelos              | Iniciar el nivel. Hacer click sobre un caramelo. Hacer click sobre alguno de los de los caramelos adyacentes. Lograr formar una fila o columna de 4 caramelos.                                                                                             | Que la combinación de estos caramelos se destruya                                      | La combinación de caramelos se destruye                     |
| 0005  | Las combinaciones accidentales de tres o más caramelos consecutivos en filas o columnas se destruyen                        | Iniciar el nivel
Hacer click sobre un caramelo
Hacer click sobre alguno de los caramelos adyacentes
Destruir caramelos formando combinaciones de tres o más en filas o columnas
Esperar que se agreguen caramelos faltantes,que todos se acomoden y que se formen combinaciones de tres o más en filas o columnas
                                                                                                | Que la combinación de estos caramelos que se destruyan                              | La combinación de caramelos 3 o más caramelos en fila o columna a veces no se destruyen.                                          |
